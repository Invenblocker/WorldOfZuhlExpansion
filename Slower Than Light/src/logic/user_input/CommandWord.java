...
{
    GO("go"), TAKE("take"), DROP("drop"), REPAIR("repair"), INVESTIGATE("investigate"), INVENTORY("inventory"), HELPER("helper"), REPAIR_DOOR("repdoor"), HELP("help"), QUIT("quit"), UNKNOWN("?"), PRINT("print");
